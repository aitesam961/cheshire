...
#			JTAG			  #
###################################################
set_property -dict {PACKAGE_PIN  N28 IOSTANDARD LVCMOS12} [get_ports jtag_tdo_o]
set_property -dict {PACKAGE_PIN  M30 IOSTANDARD LVCMOS12} [get_ports jtag_trst_ni]
set_property -dict {PACKAGE_PIN  N30 IOSTANDARD LVCMOS12} [get_ports jtag_tck_i]
set_property -dict {PACKAGE_PIN  P29 IOSTANDARD LVCMOS12} [get_ports jtag_tdi_i]
set_property -dict {PACKAGE_PIN  L31 IOSTANDARD LVCMOS12} [get_ports jtag_tms_i]
